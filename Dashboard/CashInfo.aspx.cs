...
public partial class Dashboard_CashInfo : System.Web.UI.Page
{
    ...
    private void bindKioskTxnWithLocation(string loc)
    {
        try
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                string result = client.UploadString(URL + "/GetCashTxnDetails", "POST", dataEncrypted);
    ...
    protected void GV_Kiosk_Health_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
                e.Row.Cells[7].ToolTip = "Cash Denomination";
