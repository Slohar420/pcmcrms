<%@ Page Title="Ad Managemenet | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="ScreenSaverPatchDetails.aspx.cs" Inherits="Dashboard_ScreenSavePatchDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Screen Saver Patch Details</h1>
        <ol class="breadcrumb">
            <li><a href="Adminpanel.aspx"><i class="fa fa-dashboard"></i>Panel</a></li>
            <li><a href="#"><i class="fa fa-dashboard"></i>Screen Saver Patch Details</a></li>
            ...
            <section class="col-lg-12 ">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body" style="max-height: 500px; overflow-y: scroll">
                         <div class="col-md-6">
                            <h3 class="box-title">Screen Saver Patch Details</h3>
