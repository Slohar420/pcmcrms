<%@ Page Title="Admin Panel | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="LogImage.aspx.cs" Inherits="Dashboard_BroadcastTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel(Id) {
            ...
            reportDate = FormatedTime(new Date());

            var tab_text = "";
            tab_text += "<table align='center' border='2px'><tr><td colspan='6' style='background-color:#367fa9;color:white' align='center'><h2>Logs/Images Reports Generated On (" + reportDate + ") </h2><br/></td><tr>";
            var textRange;
            var j = 0;
