<%@ Page Title="Admin Panel | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="CustomCommand.aspx.cs" Inherits="Dashboard_BroadcastTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel(Id) {
            ...
            var tab_text = "<h2>Custom Command Report</h2><br/>";
    ...
    <section class="content-header">
        <h1>Custom Command
                    <small>(Download/Upload/Execute)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="Adminpanel.aspx"><i class="fa fa-dashboard"></i>Admin Panel</a></li>
            <li class="active">Custom Command</li>
        </ol>
    </section>
