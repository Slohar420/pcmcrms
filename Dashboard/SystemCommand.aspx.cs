...
public partial class Dashboard_BroadcastTemplate : System.Web.UI.Page
{
    ...
    public void bindTemplateName()
    {
        try
        {
            ...
            tempList.Items.Insert(1, "System");
            //tempList.Items.Insert(2, "USB");
            //tempList.Items.Insert(3, "Remote");
            //tempList.Items.Insert(4, "System");
            //tempList.Items.Insert(4, "Custom Command");
        }
    ...
    protected void Broadcast_Click(object sender, EventArgs e)
    {
        ...
        if (tempList.SelectedValue.ToLower() == "system")
        {
            objReq.CommandCount = "2";
            objReq.Command = "securityupdate#" + list1.SelectedValue.ToLower();
        }
    ...
    protected void tempList_SelectedIndexChanged(object sender, EventArgs e)
    {
         if (tempList.SelectedValue.ToLower() == "system")
        {
            ...
            list1.Items.Insert(1, "Shutdown");
            list1.Items.Insert(2, "Restart");
            list1.Items.Insert(3, "Log Off");
            list1.Items.Insert(4, "Sleep");
            list1.Items.Insert(5, "Hibernate");
        }
