...
public partial class Dashboard_ScreenSavePatchDetails : System.Web.UI.Page
{
    ...
    public void bindKioskDetails()
    {
        try
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                string result = client.UploadString(URL + "/GetKioskScreenSaverDetails", "POST", "");
    ...
    protected void GV_Kiosk_Details_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            {
                string[] files = e.Row.Cells[4].Text.ToString().Split('|');
                ...
                e.Row.Cells[4].Controls.Add(panel);
            }
