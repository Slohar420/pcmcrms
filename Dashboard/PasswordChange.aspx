<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="PasswordChange.aspx.cs" Inherits="Dashboard_BroadcastTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel(Id) {
            ...
            var tab_text = "<h2>Remote Password Change Report</h2><br/>";
    ...
    <section class="content-header">
        <h1>Remote Password Change
                    <small>(Kiosk Password Updation)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="Adminpanel.aspx"><i class="fa fa-dashboard"></i>Admin Panel</a></li>
            <li class="active">Remote Password Update</li>
        </ol>
    </section>
                    ...
                    <div class="box-header with-border ">
                        <div class="col-md-2">
                           <span>Enter Username </span>
                            <a href="#" data-toggle="tooltip" title="Enter The UserName">
                         ...
                         <div runat="server" class="col-md-2" id="div1">
                           <span>Enter New Password </span>
                            <a href="#" data-toggle="tooltip" title="Enter Password To Change">
