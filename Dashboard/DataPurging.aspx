<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="DataPurging.aspx.cs" Inherits="Dashboard_BroadcastTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel(Id) {
            ...
            var tab_text = "<h2>DATA PURGING REPORT</h2><br/>";
    ...
    <section class="content-header">
        <h1>DATA PURGING
                    <small>(Deletion of Undesired Data)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="Adminpanel.aspx"><i class="fa fa-dashboard"></i>Admin Panel</a></li>
            <li class="active"> DataPurging</li>
        </ol>
    </section>
                ...
                <div class="box box-info">
                    <div class="box-header with-border ">
                        <div class="col-md-2">
                         ...
                         <div runat="server" class="col-md-2" id="div1">
                            <span>Enter Path For Purging </span>
                            <a href="#" data-toggle="tooltip" title="Enter The Path For Purging The Data">
                                <asp:TextBox  CssClass="form-control" runat="server" ID="datapurg"></asp:TextBox>
                            </a>
                        </div>

                        <div runat="server" class="col-md-2" id="div2">
                             <span>Enter The Days </span>
                            <a href="#" data-toggle="tooltip" title="Enter The Number Of Days For Purging">
                                <asp:TextBox  CssClass="form-control" runat="server" ID="days"></asp:TextBox>
                            </a>
                        </div>
