<%@ Page Title="Screen Saver Managemenet | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="ScreenSaverUpdation.aspx.cs" Inherits="Dashboard_ScreenSaverUpdation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Screen Saver Image  Update</h1>
        <ol class="breadcrumb">
            <li><a href="Adminpanel.aspx"><i class="fa fa-dashboard"></i>Panel</a></li>
            <li><a href="#"><i class="fa fa-dashboard"></i>Screen Saver Image Updation</a></li>
            ...
            <section class="col-lg-12 ">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body" style="max-height: 500px; overflow-y: scroll">
                        <div class="col-md-6">
                            <h3 class="box-title">Kiosk List For Image Updation</h3>
                        ...
                        <asp:GridView ID="GV_Kiosk_Details" class="table table-bordered table-striped table-hover" runat="server" ClientIDMode="AutoID" HeaderStyle-BackColor=" #eafafa" OnRowDataBound="GV_Kiosk_Details_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="Select">
                                    <HeaderTemplate>
                                        <a href="#" data-toggle="tooltip" title="Select All Checkbox">
                                            <input id="Checkbox2" tooltip="Show" type="checkbox" onclick="CheckAll(this)" runat="server" /></a>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-2" style="align-items: center">
                            <asp:Button runat="server" ID="instantupload" CssClass="btn btn-success form-control" OnClick="Click_Function" Text="INSTANT UPLOAD" />
                        </div>
