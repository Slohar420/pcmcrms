<%@ Page Title="Admin Panel | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="WebsiteUpdation.aspx.cs" Inherits="Dashboard_BroadcastTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Website Update
                    <small style="color:black;"><b>(Website Updation Panel)</b></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="Adminpanel.aspx"><i class="fa fa-dashboard"></i>Admin Panel</a></li>
            <li><a href="#"><i class="fa fa-dashboard"></i>Website Updation Panel</a></li>
            ...
            <section class="col-lg-12 ">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body" style="max-height: 500px; overflow-y: scroll">
                         <div class="col-md-6">
                            <h3 class="box-title">Kiosk List For Website Updation</h3>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="" style="align-items:center;display:none">
