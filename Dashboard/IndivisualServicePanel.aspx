<%@ Page Title="Service Management | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="IndivisualServicePanel.aspx.cs" Inherits="Dashboard_IndivisualServicePanel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Individual Kiosk Service Management
        </h1>
        <ol class="breadcrumb">
            <li><a href="PieChart.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li class="active">Individual Kiosk Service Management</li>
        </ol>
    </section>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col-md-12" >
                        <asp:UpdatePanel runat="server">
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="ID" DataField="ServiceId" />
                                <asp:BoundField HeaderText="SERVICE" DataField="Service" ItemStyle-Width="150px" />
                                <asp:BoundField HeaderText="STATUS" ItemStyle-Width="150px" DataField="Status" />
                                <asp:ButtonField HeaderText="CHANGE STATUS" ButtonType="Button" ControlStyle-Width="50%" ItemStyle-Width="100px" CommandName="changestatus" Text="Enable" />
                                <asp:ButtonField HeaderText="" ButtonType="Button" CommandName="delete_service" Text="Delete" Visible="false" />
                            </Columns>
                        </asp:GridView>
                            </ContentTemplate>
                            <Triggers>
