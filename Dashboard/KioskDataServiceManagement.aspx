<%@ Page Title="ServiceData Management | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="KioskDataServiceManagement.aspx.cs" Inherits="Dashboard_ReportDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Kiosk Data Service Management Panel</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
            <li class="active">Kiosk Data Service Management</li>
        </ol>
    </section>
            ...
            <section class="col-lg-12 ">
                ...
                <div class="box box-info">
                    <div class="box-header with-border ">
                        <div class="col-md-6">
                            <h3 class="box-title">Kiosk Data Service Management</h3>
                        </div>
