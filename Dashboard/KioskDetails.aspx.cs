...
public partial class KioskDetails : System.Web.UI.Page
{
            ...
            using (WebClient client = new WebClient())
            {
                ...
                if (objRes.res == true)
                {
                    ...
                    for (int i = 0; i < GV_Kiosk_Health.Rows.Count; i++)
                    {
                        ...
                        if (Convert.ToDateTime(GV_Kiosk_Health.Rows[i].Cells[15].Text) < DateTime.Now.AddMinutes(-3))   // Checking if health data was updated in previews 120 min 
                        {
                            GV_Kiosk_Health.Rows[i].Cells[5].Controls.Clear();
                            GV_Kiosk_Health.Rows[i].Cells[5].Text = "Disconnected";
                            Disconnected++;
                        }
                        else
                        {
                            GV_Kiosk_Health.Rows[i].Cells[5].Controls.Clear();
                            GV_Kiosk_Health.Rows[i].Cells[5].Text = "Connected";
                            connected++;
                        }
    ...
    protected void btn1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            float[] widArr = new float[] { 200f, 220f, 220f, 220f, 220f, 220f, 220f, 220f, 250f, 280f, 220f, 250f, 250f,250f };
