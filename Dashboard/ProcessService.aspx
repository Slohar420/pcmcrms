<%@ Page Title="Admin Panel | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="ProcessService.aspx.cs" Inherits="Dashboard_BroadcastTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel(Id) {
            ...
            var tab_text = "";
            tab_text += "<table border='2px'><tr><td style='background-color:#367fa9;color:white' align='center' colspan='6'><h2>Services/Process Report Generated On (" + reportDateTime + ")</h2><br/></td></tr> <tr>";
            var textRange;
            var j = 0;
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Services/Process</li>
        </ol>
    </section>
