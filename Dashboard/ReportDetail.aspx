<%@ Page Title="Report Details | PCMC" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="ReportDetail.aspx.cs" Inherits="Dashboard_ReportDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel(Id) {
            ...
            var tab_text = "";
            tab_text += "<table border='2px'><tr><td colspan='" + colCount + "' align='center' style='background-color:#367fa9;color:white' ><h2> Kiosk Health Report Generated On -(" + dateTime + ")</h2><br/></td><tr>";
            var textRange;
            var j = 0;
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer
            {
                ...
                let a = $("<a />", {
                    href: uri,
                    download: "PCMC_HealthDetails" + dateTime + ".xlsx"
            ...
            <section class="col-lg-12 ">
                ...
                <div class="box box-info">
                    <div class="box-header with-border ">
                        ...
                        <div class="col-md-2" runat="server" id="divPdfExport"> 
                        ...
                        <div class="col-md-2" runat="server" id="divExcelExport">
                            <span>Download Excel</span>
                            <input id="btnExport" runat="server" type="button" value="Export Report" class="btn btn-success form-control" />
                        </div>
                        <%--  <div class="col-md-2">
                             <span >Download PDF</span>
                    ...
                    <div class="box-body" runat="server" style="max-height: 500px; overflow-y: scroll">
                        ...
                        <asp:GridView ID="GV_Kiosk_Health" Width="2000" class="table table-bordered table-fixed table-striped table-hover text-center " runat="server" ClientIDMode="AutoID" HeaderStyle-BackColor=" #eafafa" OnRowDataBound="GV_Kiosk_Health_RowDataBound">
                           <Columns>
